        ...
        <div class="wrapper mod-standard mod-gray">
            <div class="details-banner">
                ...
                <div class="details-banner--hero">
                    ...
                    <asp:Image ID="Image1" class="details-banner--hero--img" runat="server" ImageUrl="~/images/" />
                </div>
                <div class="details-banner--info">
                    <a href="#" class="details-banner--info--box">

                        <asp:Image ID="Image2" class="details-banner--info--box--img" runat="server" ImageUrl="~/images/" />
                    </a>
                    <h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#">
                        <asp:Label ID="label1" runat="server" Text="Username" /></a></h1>
                </div>
            </div>
                        ...
                        <ul id="playlist" class="song-list mod-new mod-menu">
                            ...
                            <li class="song-list--item media-player--row">
                                ...
                                <div class="song-list--item--right">
                                    ...
                                    <a href="#" class="song-list--item--primary"><% HttpContext.Current.Response.Write(s.title);%></a>
                                    <% foreach (var a in albums)
                                    {
                                        if (a.albumID == s.albumID)
                                        { 			%>
                                    <a class="song-list--item--secondary"><% HttpContext.Current.Response.Write(a.title);%></a>
                                    <% }
                                    }
												%>
                                    <a class="song-list--item--secondary"><% HttpContext.Current.Response.Write(s.bpm);%></a>
                                ...
                                <div class="ly-grid ly-grid-cranberries">
                                    ...
                                    <div class="media-item">
                                        <a class="media-item--img--link" href="#" tabindex="0">
                                            <img class="media-item--img" alt="Reckless Love" src="<%= a.imageURL %>" srcset="<%= a.imageURL %>">

                                            <span class="image-tag">Master</span>
                                        </a>
                                        <a class="media-item--title" href="#" tabindex="0"><% HttpContext.Current.Response.Write(a.title);%></a>

                                        <a class="media-item--subtitle" href="#" tabindex="0">
                                            <asp:Label ID="label3" runat="server" Text="Username" /></a>
                                    </div>
                                    <% }%>
                                </div>
                                <!-- /.grid -->
